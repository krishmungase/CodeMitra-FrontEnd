...
const Codeblock = ({ heading, subheading, ctabtn1, ctabtn2, codeblock, codecolor }) => {
    return (
        <div className={`flex items-center justify-between flex-col lg:flex-row gap-y-16 lg:gap-y-0`}>
            {/* text block */}
